        ...
        <div class="row">
            <div class="col-md-4">
                <div class="property-wrap ftco-animate">
                    <a href="<?= base_url('front/rusun_detail'); ?>" class="img" style="background-image: url(<?= base_url('assets/frontend/'); ?>images/work-1.jpg);"></a>
                    <div class="text">
                        ...
                        <h3><a href="<?= base_url('front/rusun_detail'); ?>">The Blue Sky Home</a></h3>
                        <span class="location">Oakland</span>
                        <a href="<?= base_url('front/rusun_detail'); ?>" class="d-flex align-items-center justify-content-center btn-custom">
