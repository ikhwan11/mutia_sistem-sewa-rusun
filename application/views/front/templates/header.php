...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url('front/'); ?>">Sewa Rusun Batam</a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item 
                    <?php if ($this->uri->segment(1) == "front") {
                        echo "active";
                    } ?>">
                    ...
                    <li class="nav-item
                    <?php if ($this->uri->segment(1) == "rusun") {
                        echo "active";
                    } ?>">
                        <a href="<?= base_url('rusun/'); ?>" class="nav-link">Rusun</a>
                    </li>
